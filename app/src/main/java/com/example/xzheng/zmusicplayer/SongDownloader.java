...
public class SongDownloader {
    ...
    protected void onDownloadTaskCancelled() {
        _downloadHandler.onSongDownloadPaused();
    }

    protected void onDownloadTaskProgressUpdate(int progress) {
        _downloadHandler.onSongDownloadProgressUpdated(progress);
    }

    protected void onDownloadTaskError(String errorInfo) {
        _downloadHandler.onSongDownloadError(errorInfo);
    }

    protected void onDownloadTaskDone() {
    ...
    private class DownloadTask extends AsyncTask<Song, Integer, String> {
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            onDownloadTaskProgressUpdate(values[0]);
        }

        @Override
        protected void onCancelled(String result) {
            super.onCancelled(result);
            onDownloadTaskCancelled();
        }
    }
}
